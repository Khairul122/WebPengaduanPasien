<?php 
  ...
  $data = mysqli_query($koneksi,"select * from tbl_masyarakat where id_masyarakat='$idm'");
...
<head>
  ...
  <title>Pengaduan - Ubah Akun</title>
                ...
                ?>
                  ...
                  <form action="update-akun.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <input type="text" class="form-control" value="<?php echo $row['nik']; ?>" disabled>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
